  ...
  render() {
    ...
    const btnHandle = () => {
      if (!email || !password) {
        ...
        return fetch('https://mobilio1.herokuapp.com/signin', {
          method: 'post',
          headers: {
          ...
          {this.state.loading ? (
            <View
              style={{
                ...
                width: '30%',
                height: 40,
                backgroundColor: '#5d17cf',
                borderRadius: 5,
              }}>
              <ActivityIndicator
                style={{top: 10, top: '5%', height: 30, top: 4}}
                size="small"
                color="white"
              />
            </View>
            ...
            <Button
              testID="signin"
              onPress={btnHandle}
              style={{top: 10, top: '5%', width: '90%', height: 40}}
              mode="contained">
              Signin
            </Button>
          )}
